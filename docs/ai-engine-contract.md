...
Версия Python-пакета: `0.3.0`. Версия JSON-схемы результатов: `1.0`, снимка: `snapshot_version=1`, ветки: `investigation_version=2`, досье обогащения: `enrichment_version=1`.
